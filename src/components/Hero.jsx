...
const currentFloatingCard = floatingCards[activeTab];
    ...
    return (  <section className="relative min-h-screen items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
     <div className="absolute inset-0 opacity-30" style={{
        background: `radial-gradient(600px circle at ${mousePosition.x}px ${mousePosition.x}px, #1e00ffff, #000000)`
     }}>
        ...
        <div className="relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-1xl p-1 sm:p-4 shadow-2xl border border-white/10">
            <div className="bg-gradient-to-br from-gray-900/20 to-gray-800/20 backdrop-blur-sm rounded-lg overflow-hidden h-[280px]    lg:h-[450px] border-white/10" >
                ...
                <div className="flex space-x-1 sm:space-x-2 mb-3 sm:mb-4 overflow-x-auto">
                     ...
                     className={`px-3 py-2 backdrop-blur-sm text-xs sm:text-sm rounded-t-lg border ${ activeTab === "Hero.jsx" ? "bg-blue-500/30 text-white border-blue-400/20" : " bg-white/5 text-gray-300 border-white/10 hover:bg-white/10" }  transition-all duration-200 whitespace-nowrap`}>Hero.jsx</button>
                     <button
